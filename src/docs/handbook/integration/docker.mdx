...
{`docker pull ghcr.io/serenity-js/playwright:v`}<PlaywrightVersion />{`-resolute`}
</DynamicCodeBlock>
...
{`FROM ghcr.io/serenity-js/playwright:v`}<PlaywrightVersion />{`-resolute
