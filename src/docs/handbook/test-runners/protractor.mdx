...
[Extending Protractor with Serenity/JS](/handbook/test-runners/protractor/).
:::
...
[`@serenity-js/protractor` module](/api/protractor) provides a [**test runner adapter**](/handbook/architecture)
...
Follow the [Serenity/JS Protractor migration guide](/handbook/test-runners/protractor/#migrating-from-protractor-to-serenityjs)
...
Check out the [Protractor migration guide](/handbook/test-runners/protractor/#migrating-from-protractor-to-serenityjs) below 👇👇👇
:::
