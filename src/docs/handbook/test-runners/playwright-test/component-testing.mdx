...
Install and configure the Serenity/JS Playwright Test integration as described in [Installation](/handbook/test-runners/playwright-test/installation/). Component testing then requires the UI framework and tooling that serve your story gallery. This example uses a React gallery with Vite; other frameworks need their own equivalents:
