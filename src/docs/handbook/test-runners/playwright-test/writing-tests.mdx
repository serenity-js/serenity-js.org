...
Serenity/JS integrates with Playwright Test and adds Screenplay Pattern APIs to your scenarios. Playwright Test continues to provide the test runner and browser fixtures; Serenity/JS provides Actors, Tasks, and Questions that you can use alongside the existing APIs. This guide explains how to organise scenarios and use those APIs.
...
Next, learn how to [test components in isolation](/handbook/test-runners/playwright-test/component-testing/). Then explore [multi-actor scenarios](/handbook/test-runners/playwright-test/multi-actor-scenarios/) and [customising actors](/handbook/test-runners/playwright-test/customising-actors/).
