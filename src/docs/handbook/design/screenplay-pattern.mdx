...
To follow along with the coding, get one of the [**Serenity/JS Project Templates**](/getting-started/project-templates/) as they come with everything you need to get started with Serenity/JS.
:::
...
When you're ready to **start your own test automation project**, use one of the available [**Serenity/JS Project Templates**](/getting-started/project-templates/)
...
Thanks to [GitHub Codespaces](/getting-started/project-templates/#serenityjs-codespaces),
you can follow the [web testing tutorial](/handbook/tutorials/your-first-web-scenario)
and use any of the [Serenity/JS Project Templates](/getting-started/project-templates/) right here in your browser,
