...
Make sure to review the [examples and reference implementations](https://github.com/serenity-js/serenity-js/tree/main/examples), as well as [Serenity/JS REST API testing Project Templates](/getting-started/project-templates/#resthttp-api-testing)
