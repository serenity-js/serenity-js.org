...
- [HTML Reporter](/handbook/reporting/html-reporter) - produces a self-contained HTML report with dashboard, trend history, and interactive scenario details — no Java required,
...
:::tip Get started with reporting in 5 minutes
If you're using Playwright Test, you can add Serenity/JS reporting with a single config update — no test rewrites needed.
Follow the [Serenity/JS for Playwright Users](/getting-started/playwright/) guide to set it up.
:::
