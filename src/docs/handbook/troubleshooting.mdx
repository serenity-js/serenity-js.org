...
Serenity/JS is tested with the latest versions of Node.js <SupportedNodeVersions conjunction="and" />. Use a recent [Long-Term Support (LTS)](https://github.com/nodejs/Release) version for optimal stability. While non-LTS versions may work, they are not officially supported.
