...
With each tutorial, you'll embark on a practical journey through the framework, discovering how to extend the [Serenity/JS Project Templates](/getting-started/project-templates/) to solve real-world test automation challenges.
...
- [Upgrading from Serenity/JS 2](/releases/upgrading-from-serenity-js-2/) – Explore what's new in Serenity/JS 3 and learn how to upgrade your existing Serenity/JS 2 projects.
