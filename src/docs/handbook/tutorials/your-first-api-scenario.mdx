...
Remember that each Serenity/JS template comes with a [GitHub Codespace](/handbook/project-templates/#serenityjs-codespaces) that uses a dedicated Docker image with all the required dependencies
