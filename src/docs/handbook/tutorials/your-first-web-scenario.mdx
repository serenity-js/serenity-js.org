...
To keep things simple, we'll use a [**GitHub Codespace**](/handbook/project-templates/#serenityjs-codespaces) to work with Serenity/JS in your web browser, so there's **no need to install anything** on your computer.
...
support [GitHub Codespaces](/handbook/project-templates/#serenityjs-codespaces) and are configured to
...
such as Selenium, Playwright and WebdriverIO. Once you know your way around your first [Serenity/JS project template](/handbook/project-templates/),
