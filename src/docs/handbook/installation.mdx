...
- [**Serenity/JS Project Templates**](/getting-started/project-templates/) - Pre-configured with essential dependencies.
...
- [Serenity/JS Project Templates](/getting-started/project-templates/)
