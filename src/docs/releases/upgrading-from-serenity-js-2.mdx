...
All the [Serenity/JS Project Templates](/getting-started/project-templates/) are migrated to Serenity/JS 3.
...
- [Playwright Test](/handbook/test-runners/playwright-test/customising-actors/#replacing-the-default-actors)
