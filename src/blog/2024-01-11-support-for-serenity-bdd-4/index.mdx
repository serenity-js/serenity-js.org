...
[**Serenity/JS 3.15.0**](https://github.com/serenity-js/serenity-js/releases/tag/v3.15.0) introduces support for **Serenity BDD 4** and aggregated test reports for Playwright Test, WebdriverIO, Mocha, Jasmine and Cucumber! 🥳
...
Learn more about [Configuring Serenity BDD Reporter](/handbook/reporting/serenity-bdd-reporter/#configuration-overview).
