...
# Compare Test Architectures

Serenity/JS isn't a replacement for Playwright or WebdriverIO — it's a **layer on top** that adds structure, reporting, and reusability as your test suite grows.
...
Change one import. Your test code stays identical, but you get structured activity reports showing what each test did, step by step.
...
**What you gain:** Activity breakdown with timing, automatic screenshots on failure, Serenity BDD living documentation — all with zero changes to your test logic.
