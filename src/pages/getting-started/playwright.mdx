...
→ Learn more: [Full installation guide](/handbook/test-runners/playwright-test/installation/) | [Compare test architectures](/compare/)
...
- **[Compare test architectures](/compare/)** — same test at three levels of abstraction
