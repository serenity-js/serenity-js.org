...
→ Learn more: [Full installation guide](/handbook/test-runners/playwright-test/installation/) | [Why Serenity/JS?](/compare/)
...
- **[Why Serenity/JS?](/compare/)** — same test at three levels of abstraction
