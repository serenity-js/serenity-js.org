...
→ Learn more: [Full installation guide](/handbook/test-runners/playwright-test/installation/) | [Why Serenity/JS?](/why-serenity-js/)
...
- **[Why Serenity/JS?](/why-serenity-js/)** — same test at three levels of abstraction
